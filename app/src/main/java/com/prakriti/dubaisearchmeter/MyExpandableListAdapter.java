...
public class MyExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
       ChildRow childRow = (ChildRow) getChild(groupPosition, childPosition);
        ...
        final TextView childText = (TextView) convertView.findViewById(R.id.chlid_text);
    ...
    public void filterData(String query){
        ...
        if (query.isEmpty()){
        ...
        else for (ParentRow parentRow :originalList){
            ...
            if(newList.size()> 0){
                ParentRow parentRow1 = new ParentRow(parentRow.getName(),newList);
                parentRowList.add(parentRow1);
            }
        }
